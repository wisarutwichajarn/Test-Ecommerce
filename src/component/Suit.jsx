    ...
    const products = [
      {
        ...
        discount: '81%',
        imageUrl: 'https://www.pngarts.com/files/3/Blue-Suit-PNG-Download-Image.png'
      },
      {
        id: 2,
        name: 'Product 3',
        ...
        discount: '45%',
        imageUrl: 'http://pngimg.com/uploads/suit/suit_PNG93219.png'
      },
      {
        id: 2,
        name: 'Product 4',
        ...
        discount: '7%',
        imageUrl: 'https://static.vecteezy.com/system/resources/previews/021/505/927/original/brown-half-suit-with-black-tie-free-png.png'
      },
      {
        id: 2,
        name: 'Product 5',
        ...
        originalPrice: 259.00,
        discount: '7%',
        imageUrl: 'https://png.pngtree.com/png-clipart/20230425/original/pngtree-mens-pink-suit-png-image_9099492.png'
      },
            ...
            <div className="bg-gradient-to-r from-primary-yellowLOginGradient1 to-primary-yellowNavbarGradient mb-[3rem] 
                     ...
                     <div className="md:flex p-4 ">
                        <div className="scale-75 md:scale-100 flex flex-col justify-center">
                          <img src="https://pngimg.com/uploads/suit/suit_PNG93239.png" 
                          alt="" 
                        ...
                        <div className="ml-4">
                            ...
                            <div className=" pt-2 text-[3.5rem] font-medium text-orange-400 ">$ 345.00</div>
                            <div className="flex ">
                              <div className="pl-2 text-[1.5rem] line-through">$ 310.00</div>
