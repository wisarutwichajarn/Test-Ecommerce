  ...
  const products = [
    {
      ...
      discount: '81%',
      imageUrl: 'https://pngimg.com/uploads/dress_shirt/dress_shirt_PNG8081.png'
    },
    {
      id: 2,
      name: 'Product 3',
                ...
                <div className="bg-gradient-to-r from-primary-yellowLOginGradient1 to-primary-yellowNavbarGradient mb-[3rem] 
                         ...
                         <div className="md:flex p-4 ">
                            <div className="scale-75 md:scale-100 flex flex-col justify-center">
                              <img src="https://www.pngall.com/wp-content/uploads/5/Long-Sleeve-Shirt-PNG-Picture.png" 
                              alt="" 
                            ...
                            <div className="ml-4">
                                ...
                                <div className=" pt-2 text-[3.5rem] font-medium text-orange-400 ">$ 120.00</div>
                                <div className="flex ">
                                  <div className="pl-2 text-[1.5rem] line-through">$ 240.00</div>
