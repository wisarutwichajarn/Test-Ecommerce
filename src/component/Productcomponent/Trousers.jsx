    ...
    const products = [
      {
        ...
        discount: '81%',
        imageUrl: 'https://www.pngall.com/wp-content/uploads/5/Pant-PNG-Pic.png'
      },
      {
        id: 2,
        name: 'Product 3',
        ...
        discount: '45%',
        imageUrl: 'https://pnghq.com/wp-content/uploads/black-cargo-pants-png-free-png-images-45564-1024x1024.png'
      },
      {
        id: 2,
        name: 'Product 4',
        ...
        discount: '7%',
        imageUrl: 'http://www.pngall.com/wp-content/uploads/2016/09/Trouser-PNG-Picture.png'
      },
      {
        id: 2,
        name: 'Product 5',
        ...
        originalPrice: 259.00,
        discount: '7%',
        imageUrl: 'https://www.pngmart.com/files/7/Khaki-Pant-Transparent-Background.png'
      },
            ...
            <div className="bg-gradient-to-r from-primary-yellowLOginGradient1 to-primary-yellowNavbarGradient mb-[3rem] 
                     ...
                     <div className="md:flex p-4 ">
                        <div className="scale-75 md:scale-100 flex flex-col justify-center">
                          <img src="https://pluspng.com/img-png/trousers-png-hd-trouser-free-png-image-1500.png" 
                          alt="" 
                        ...
                        <div className="ml-4">
                            ...
                            <div className=" pt-2 text-[3.5rem] font-medium text-orange-400 ">$ 100.00</div>
                            <div className="flex ">
