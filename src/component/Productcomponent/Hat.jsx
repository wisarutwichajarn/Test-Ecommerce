    ...
    const products = [
      {
        ...
        discount: '81%',
        imageUrl: 'https://purepng.com/public/uploads/large/purepng.com-cowboy-hathat-fashion-objects-horse-cap-cowboy-rodeoclothingcowboy-hat-631522935781ujl5x.png'
      },
      {
        id: 2,
        name: 'Product 3',
        ...
        discount: '45%',
        imageUrl: 'https://clipartix.com/wp-content/uploads/2019/02/cowboy-hat-transparent-2019-29.png'
      },
      {
        id: 2,
        name: 'Product 4',
        ...
        discount: '7%',
        imageUrl: 'https://4.bp.blogspot.com/-CMISJndSf5c/WFqk0KTkrlI/AAAAAAAAD1Q/lWBcQM2_rbgOWqW2a5me0twIVkrBLqKCgCLcB/s1600/christmas_hat_transparent_image.png'
      },
      {
        id: 2,
        name: 'Product 5',
        ...
        originalPrice: 259.00,
        discount: '7%',
        imageUrl: 'https://purepng.com/public/uploads/large/purepng.com-black-top-hathatsstandard-sizeblackcliparttopred-round-1421526359368p8ziu.png'
      },
            ...
            <div className="bg-gradient-to-r from-primary-yellowLOginGradient1 to-primary-yellowNavbarGradient mb-[3rem] 
                     ...
                     <div className="md:flex p-4 ">
                        <div className="scale-75 md:scale-100 flex flex-col justify-center">
                          <img src="http://www.pngall.com/wp-content/uploads/2016/07/Cowboy-Hat-Download-PNG.png" 
                          alt="" 
                        ...
                        <div className="ml-4">
                            ...
                            <div className="flex items-center ">
                              ...
                              <MdOutlineStarPurple500 className='scale-110 mb-1' />
                              <MdOutlineStarPurple500 className='scale-110 mb-1' />
                              <div className="pl-2 mb-1 text-gray-500 ">8 Ratings</div>
                            </div>
                            ...
                            <div className=" pt-2 text-[3.5rem] font-medium text-orange-400 ">$ 85.00</div>
                            <div className="flex ">
                              <div className="pl-2 text-[1.5rem] line-through">$ 110.00</div>
