...
function Shoe() {
    ...
    const products = [
      {
        ...
        discount: '81%',
        imageUrl: 'http://pluspng.com/img-png/shoes-png-nike-shoes-transparent-background-800.png'
      },
      {
        id: 2,
        name: 'Product 3',
        ...
        discount: '45%',
        imageUrl: 'https://pngimg.com/uploads/converse/converse_PNG44.png'
      },
      {
        id: 2,
        name: 'Product 4',
        ...
        discount: '7%',
        imageUrl: 'http://pngimg.com/uploads/running_shoes/running_shoes_PNG5824.png'
      },
      {
        id: 2,
        name: 'Product 5',
        ...
        originalPrice: 259.00,
        discount: '7%',
        imageUrl: 'https://pluspng.com/img-png/running-shoes-png-image-1459.png'
      },
    ...
    const comments =[
      {
        id:1,
        name:'Mr.Wisarut JK.',
        text:"The products at your store are of great quality and reasonably priced. The owner is friendly and offers excellent service. Quick and attentive, I'll definitely come back and recommend this place to my friends!",
        date:'6 May 2024',
      },
      {
        id:2,
        name:'Mr.DEAr SC.',
        text:"I'm very pleased with my purchase! The items are exactly as described, and the overall shopping experience was fantastic. The staff were very helpful and attentive. I appreciate the prompt delivery and the quality of the products. I will definitely be shopping here again and will recommend this store to my family and friends.",
        date:'12 Jan 2023',
      },
      {
        id:3,
    ...
    const handleAddToCart = () => {
      // Logic for adding the item to the cart can go here
            ...
            <div className="bg-gradient-to-r from-primary-yellowLOginGradient1 to-primary-yellowNavbarGradient mb-[3rem] 
                     ...
                     <div className="md:flex p-4 ">
                        <div className="scale-75 md:scale-100 flex flex-col justify-center">
                          <img src="https://purepng.com/public/uploads/large/purepng.com-men-shoesmen-shoesfashiondesignestylehuman-footchocolate-14215263914283nuta.png" 
                          alt="" 
                          className='w-[30rem] transition-all hover:scale-105 hover:brightness-110 p-5'/>
                        </div>
                        <div className="ml-4">
                            <div className="font-light text-[3.5rem]">Product 1</div>
                            <div className="flex items-center ">
                              ...
                              <div className="pl-2 mb-1 text-gray-500 ">34 Ratings</div>
                            </div>
                            <div className="flex justify-between mt-[2rem] ">
                              <div className="font-extralight text-[1.2rem]">Brand : Shoe</div>
                            ...
                            <div className=" pt-2 text-[3.5rem] font-medium text-orange-400 ">$ 215.00</div>
                            <div className="flex ">
                              <div className="pl-2 text-[1.5rem] line-through">$ 235.00</div>
                            ...
                            <div className="flex  p-2 mt-[1rem]  ">
                                  <button className=" p-8 bg-yellow-400 mr-16 rounded-2xl active:bg-yellow-500 text-white font-bold text-[1.35rem] hover:shadow-lg">
                                   ...
                                   <button className="p-8 bg-yellow-400 rounded-2xl active:bg-yellow-500 text-white font-bold text-[1.35rem] hover:shadow-lg" onClick={handleAddToCart}>
                                    Add to Cart
                                 </button>
                            </div>
